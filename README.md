# :memo: Note Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Note-Power-Toy-For-Magento-2-small.png">  

Note Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a quick action toy 
allowing to save quick notes/memos in your Magento store.
...
* Option to quickly save notes/memos in Magento
...
<td>
    <table>
     <tr>
        <td><b>Notes Toy</b><br>Dark Mode</td>
        <td><b>Notes Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Note-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Note-Power-Toy-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Note/Memo Popup</b><br>Dark Mode</td>
        <td><b>Note/Memo Popup</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Note-Power-Toy-Memo-Popup-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Note-Power-Toy-Memo-Popup-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-note
```

## Using Note Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Note Toy.  
...
displaying the Note Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Note_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-note/blob/master/LICENSE)
